...
public class SearchController {
    ...
    public String list(PmsSearchParam pmsSearchParam, ModelMap modelMap) {//三级分类id关键字类
        ...
        if (delValueIds != null) {
            //当前请求包含了平台属性的筛选，每个参数都会生成一个面包屑
            //面包屑
            List<PmsSearchCrumb> pmsSearchCrumbs = new ArrayList<>();

            for (String delValueId : delValueIds) {
                Iterator<PmsBaseAttrInfo> iterator = pmsBaseAttrInfos.iterator();//平台属性集合需要放进循环
                PmsSearchCrumb pmsSearchCrumb = new PmsSearchCrumb();
                //shnegcheng mianbaoxie canshu
